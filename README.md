...
### Installation
[Install the GitHub integration for Slack](https://dslbd.slack.com/apps/ADBP232DB-dishangbd) or [Install the DishangBD for Slack](https://slack.com/apps/ADBP232DB-dishangbd). After you've signed in to your Slack workspace, you will be prompted to give the app access:
